                            ...
                            <div className='flex items-center flex-col sm:flex-row'>
                                ...
                                <div className='flex justify-start w-full mx-auto items-center'>
                                    <div className=' w-full sm:w-1/2 sm:pr-8'>
                                        ...
                                        data-aos-duration = '1200' 
                                        className='bg-white p-4 rounded shadow group hover:bg-primaryColor cursor-pointer ease-in duration-150'>
                                            <h3 className='text-primaryColor font-[700] mb-3 group-hover:text-white group-hover:font-[600]text-xl '>Technologies/ Skills</h3>
                                            <p className='text-[15px] text-smallTextColor group-hover:text-white group-hover:font-[500] leading-7'>
                                            Javascript, Typescript, Node.js, express.js, Angular, React, Bootsrap, Tailwind, HTML, CSS,UI/UX design(figma), Trello, Github.
                                                </p>
